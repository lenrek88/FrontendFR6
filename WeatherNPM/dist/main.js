...
let likeArray = (0, _localstorageJs.storage).getFavoriteCities() ? (0, _localstorageJs.storage).getFavoriteCities() : new Set();
...
let currentCity = (0, _localstorageJs.storage).getCurrentCity() ? (0, _localstorageJs.storage).getCurrentCity() : "Aktobe";
function Logger() {
    this.result = 0;
    this.start = function() {
...
async function formHandler(e) {
    ...
    console.log((0, _localstorageJs.storage).getFavoriteCities());
    ...
    (0, _localstorageJs.storage).saveCurrentCity(cityName);
...
function likeElementHandler(event) {
    ...
    (0, _localstorageJs.storage).saveFavoriteCities(likeArray);
    renderUiLike();
}
...
},{"./localstorage.js":"gMM27","date-fns":"dU215"}],"gMM27":[function(require,module,exports) {
...
},{"387b0aecfe84b867":"1vXXw"}]},["1yfyN","adjPd"], "adjPd", "parcelRequire86fa")

...
var _coockiesJs = require("./coockies.js");
...
let likeArray = (0, _coockiesJs.storage).getFavoriteCities("FavoriteCity") ? (0, _coockiesJs.storage).getFavoriteCities("FavoriteCity") : new Set();
...
let currentCity = (0, _coockiesJs.storage).getCurrentCity() ? (0, _coockiesJs.storage).getCurrentCity() : "Aktobe";
function Logger() {
    this.result = 0;
    this.start = function() {
...
async function formHandler(e) {
    ...
    (0, _coockiesJs.storage).saveCurrentCity(cityName);
    ...
    try {
        ...
        if (thisCloud3) thisCloud3.replaceWith(thisCloud);
        else cloudTemp.append(thisCloud);
...
function getUrlImage(id) {
    if (id === 800) return "url(https://openweathermap.org/img/wn/01d@4x.png)";
    else if (id === 801) return "url(https://openweathermap.org/img/wn/02d@4x.png)";
    else if (id === 802) return "url(https://openweathermap.org/img/wn/03d@4x.png)";
    else if (id === 803 || id === 804) return "url(https://openweathermap.org/img/wn/04d@4x.png)";
    else if (id > 199 && id < 233) return "url(https://openweathermap.org/img/wn/11d@4x.png)";
    else if (id > 299 && id < 322) return "url(https://openweathermap.org/img/wn/09d@4x.png)";
    else if (id > 499 && id < 505) return "url(https://openweathermap.org/img/wn/10d@4x.png)";
    else if (id === 511) return "url(https://openweathermap.org/img/wn/13d@4x.png)";
    else if (id > 519 && id < 532) return "url(https://openweathermap.org/img/wn/09d@4x.png)";
    else if (id > 599 && id < 623) return "url(https://openweathermap.org/img/wn/09d@4x.png)";
    else if (id > 700 && id < 782) return "url(https://openweathermap.org/img/wn/50d@4x.png)";
}
async function forecastF(cityName) {
    const deleteDiv = document.querySelectorAll(".forecast");
    for (let elem of deleteDiv)elem.remove();
...
function likeElementHandler(event) {
    ...
    (0, _coockiesJs.storage).saveFavoriteCities(likeArray);
    renderUiLike();
}
...
},{"./coockies.js":"dtTQI"}],"dtTQI":[function(require,module,exports) {
...
const storage = {
    saveFavoriteCities (city) {
        (0, _jsCookieDefault.default).set("FavoriteCity", JSON.stringify([
            ...city
        ]), {
            expires: 30
        });
    ...
    getFavoriteCities () {
        if ((0, _jsCookieDefault.default).get("FavoriteCity") !== undefined) return new Set(JSON.parse((0, _jsCookieDefault.default).get("FavoriteCity")));
    },
    saveCurrentCity (city) {
        (0, _jsCookieDefault.default).set("ThisCity", city, {
            expires: 30
        });
    },
    getCurrentCity () {
        return (0, _jsCookieDefault.default).get("ThisCity");
    }
};
...
},{}]},["1yfyN","adjPd"], "adjPd", "parcelRequire86fa")

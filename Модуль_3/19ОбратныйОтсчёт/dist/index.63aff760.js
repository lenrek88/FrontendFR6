...
var _dateFnsDefault = parcelHelpers.interopDefault(_dateFns);
...
mainForm.addEventListener("submit", function(event) {
    ...
    let temp = (0, _dateFnsDefault.default).differenceInYears(y, x);
    let result = temp + " \u043B\u0435\u0442 ";
    x = (0, _dateFnsDefault.default).addYears(x, temp);
    temp = (0, _dateFnsDefault.default).differenceInDays(y, x);
    result = result + temp + " \u0434\u043D\u0435\u0439 ";
    x = (0, _dateFnsDefault.default).addDays(x, temp);
    temp = (0, _dateFnsDefault.default).differenceInHours(y, x);
    result = result + temp + " \u0447\u0430\u0441\u043E\u0432 ";
    const text = document.querySelector(".text");
    text.textContent = result;
});

},{"date-fns":"dU215","@parcel/transformer-js/src/esmodule-helpers.js":"ds8Li"}],"dU215":[function(require,module,exports) {
"use strict";
...
},{"387b0aecfe84b867":"1vXXw"}],"ds8Li":[function(require,module,exports) {
...
},{}]},["7Sc3p","adjPd"], "adjPd", "parcelRequire4482")
